...
document.querySelectorAll("input").forEach((inputField) => {
  inputField.addEventListener("input", function() {
    ...
    if(Hh === 0 && H !== 0 && Al !== 0){
      sumKwas += H + Al
      elementHh.disabled = true;
      elementHh.placeholder = "zresetuj by wpisać";
      ...
      sumKwas += Hh;
      elementH.disabled = true;
      elementAl.disabled = true;  
      elementH.placeholder = "zresetuj by wpisać";
      elementAl.placeholder = "zresetuj by wpisać";
